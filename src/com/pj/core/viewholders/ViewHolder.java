	...
	public class NavigationBar{
		...
		public Button getDefaultGobackButton() {
			if (defaultGobackButton==null) {
				...
				defaultGobackButton.setBackgroundColor(Color.TRANSPARENT);
				defaultGobackButton.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
				defaultGobackButton.setTextColor(Color.WHITE);
			}
